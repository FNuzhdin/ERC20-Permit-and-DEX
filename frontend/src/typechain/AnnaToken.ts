...
export interface AnnaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface AnnaToken extends BaseContract {
  connect(runner?: ContractRunner | null): AnnaToken;
  waitForDeployment(): Promise<this>;

  interface: AnnaTokenInterface;
